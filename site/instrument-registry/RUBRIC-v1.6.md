...
**Version 1.6, 3 September 2026, before first publication.** Changes from 1.5, all made after a fifth independent check of dataset v0.8.0, scoped to the v0.7.0 to v0.8.0 diff, returned fit to publish with one grade to move and two corrections of wording:
