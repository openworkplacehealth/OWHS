...
rebuild after the lift cannot quietly put noindex back. Idempotent. Run before any deploy."""
...
for p in sorted(SITE.rglob("*.html")):
    ...
    if rel == "404.html":
        continue  # the not-found page is always noindex and never canonical; it stamps itself
