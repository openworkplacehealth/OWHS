...
| `schemas/` | Versioned JSON Schemas: sixteen v0.2 entity types and the three preserved v0.1 entity types; see the catalogue for exact identifiers, examples and validation scope. |
