...
Substantive changes to the standard are made by public RFC: a written proposal, an open comment window, and a recorded decision with reasons (see [GOVERNANCE.md](../GOVERNANCE.md)). Each RFC is one file here, numbered in the order it was opened.
